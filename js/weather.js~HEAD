...
var pass = function(weather){   
    ...
    {
            $("body").css("background",
        "url(http://news.nationalgeographic.com/content/dam/news/2015/04/11/extremeweathergallery/14extremeweather.ngsversion.1470938513000.jpg) center center no-repeat fixedd");
            $("body").css('background-size','cover');
    }
